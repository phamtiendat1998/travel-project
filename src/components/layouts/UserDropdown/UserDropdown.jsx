...
export class UserDropdown extends Component {
    ...
    handleToggle() {
        this.setState(state => ({ openToggle: !state.openToggle }));
    }
    handleClose(event) {
